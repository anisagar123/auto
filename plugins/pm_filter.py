...
import os
req_channel = int(os.environ.get('REQ_CHANNEL'.'-1001677409521'))
...
async def pm_next_page(bot, query):
    ...
    btn.insert(0,
        ...
        [
            ...
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/TG_UPDATES1/313')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("♚ BOT OWNER", url="https://t.me/KUSHALHK"), 
        ...
        buttons = [[
            InlineKeyboardButton('SOURCE CODE', url='https://t.me/TG_UPDATES1')
            ],[
