...
# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "99999"))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'TG_LINKS_CHANNEL')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
PM_IMDB = environ.get('PM_IMDB', "True")
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "{filename} ╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗ @TG_LINKS_CHANNEL\n@TG_LINKS_CHANNEL ╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╝")
